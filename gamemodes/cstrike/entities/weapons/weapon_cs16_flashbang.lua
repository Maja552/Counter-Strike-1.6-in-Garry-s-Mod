...
SWEP.Weight				= CS16_FLASHBANG_WEIGHT
SWEP.HoldType			= "grenade"

SWEP.Category			= "Counter-Strike"
SWEP.Spawnable			= true

--SWEP.PModel				= Model("models/weapons/cs16/p_flashbang.mdl")
SWEP.PModel				= Model("models/cs/p_flashbang.mdl")
SWEP.WModel				= Model("models/cs16/w_flashbang.mdl")
SWEP.VModel				= Model("models/weapons/cs16/c_flashbang.mdl")
--SWEP.VModel				= Model("models/cs/v_flashbang.mdl")

SWEP.PModelShield		= Model("models/weapons/cs16/shield/p_shield_flashbang.mdl")
SWEP.VModelShield		= Model("models/weapons/cs16/shield/v_shield_flashbang.mdl")

SWEP.ViewModel			= SWEP.VModel
SWEP.WorldModel			= SWEP.PModel

SWEP.Primary.ClipSize		= -1
--SWEP.Primary.DefaultClip	= CS16_FLASHBANG_MAX_CARRY
SWEP.Primary.DefaultClip	= 0
SWEP.Primary.Ammo			= "CS16_FLASHBANG"

SWEP.AnimPrefix 			= "grenade"
SWEP.MaxSpeed 				= CS16_FLASHBANG_MAX_SPEED
SWEP.Price 					= 200
SWEP.IsGrenade 				= true
...
if !gmod.GetGamemode().IsCStrike then
	SWEP.Slot			= 4
	SWEP.SlotPos		= 1
	SWEP.PModel			= Model("models/weapons/cs16/player/p_flashbang.mdl")
end
...
function SWEP:Throw()
	...
	if SERVER then
		local grenade = ents.Create("ent_cs16_flashbang")
