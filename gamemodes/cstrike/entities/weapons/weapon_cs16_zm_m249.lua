...
if CLIENT then
	...
	killicons_new.Add("weapon_cs16_zm_m249", "cs/sprites/m249_killicon", Color(255, 255, 255, 255))
end
...
function SWEP:M249Fire(flSpread, flCycleTime)
	...
	self.Owner:FireBullets3(self, self.Owner:GetShootPos(), self.Owner:EyeAngles() + self.Owner:CS16_GetViewPunch(), flSpread, CS16_M249_DISTANCE, CS16_M249_PENETRATION, "CS16_556NATOBOX", CS16_M249_DAMAGE * 1.25, CS16_M249_RANGE_MODIFER, self.Owner, true, self.Owner:EntIndex())
...
function SWEP:Reload()
	...
	if self:CS16_DefaultReload(CS16_M249_MAX_CLIP, ACT_VM_RELOAD, CS16_M249_RELOAD_TIME - 1.9) then
		self:SetAccuracy(0.2)
