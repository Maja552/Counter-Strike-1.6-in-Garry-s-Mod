...
if CLIENT then
	...
	killicons_new.Add("weapon_cs16_pb_usp", "cs/sprites/usp_killicon", Color(255, 255, 255, 255))
end
...
SWEP.VModel 			= Model("models/weapons/cs16/paintball/v_pb_usp.mdl")
...
function SWEP:USPFire(flSpread, flCycleTime)
	...
	self.Owner:CS16_SetViewPunch(self.Owner:CS16_GetViewPunch() + Angle(-1, 0, 0), true)
