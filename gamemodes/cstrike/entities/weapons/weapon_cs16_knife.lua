...
if CLIENT then
	...
	killicons_new.Add("weapon_cs16_knife", "cs/sprites/knife_killicon", Color(255, 255, 255, 255))
end
...
SWEP.VModel				= Model("models/weapons/cs16/c_knife.mdl")
--SWEP.VModel				= Model("models/weapons/cs16/special/v_knife_miku.mdl")
...
SWEP.MaxSpeed 				= CS16_KNIFE_MAX_SPEED
