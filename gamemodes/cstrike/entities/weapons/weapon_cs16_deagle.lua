...
if CLIENT then
	...
	killicons_new.Add("weapon_cs16_deagle", "cs/sprites/deagle_killicon", Color(255, 255, 255, 255))
end
...
SWEP.VModel				= Model("models/weapons/cs16/c_deagle.mdl")
...
function SWEP:DEAGLEFire(flSpread, flCycleTime)
	...
	self:CS16_MuzzleFlash(21, 15)
	self.Owner:SetAnimation(PLAYER_ATTACK1)

	self.Owner:FireBullets3(self, self.Owner:GetShootPos(), self.Owner:EyeAngles() + self.Owner:CS16_GetViewPunch(), flSpread, CS16_DEAGLE_DISTANCE, CS16_DEAGLE_PENETRATION, "CS16_50AE", CS16_DEAGLE_DAMAGE, CS16_DEAGLE_RANGE_MODIFER, self.Owner, true, self.Owner:EntIndex())
...
function SWEP:Reload()
	...
	if self:CS16_DefaultReload(CS16_DEAGLE_MAX_CLIP, ACT_VM_RELOAD, CS16_DEAGLE_RELOAD_TIME, true) then
		self:SetAccuracy(0.9)
	end
end
