...
if CLIENT then
	...
	killicons_new.Add("weapon_cs16_zm_infectgrenade", "cs/sprites/hegrenade_killicon", Color(255, 255, 255, 255))
	killicons_new.Add("ent_cs16_infectgrenade", "cs/sprites/hegrenade_killicon", Color(255, 255, 255, 255))
end
...
SWEP.VModel				= Model("models/weapons/cs16/zombie_mod/v_grenade_infect.mdl")
...
SWEP.MaxSpeed 				= CS16_HEGRENADE_MAX_SPEED
SWEP.Price 					= 300
SWEP.IsGrenade 				= true
...
function SWEP:Throw()
	...
	if SERVER then
		local grenade = ents.Create("ent_cs16_infectgrenade")
