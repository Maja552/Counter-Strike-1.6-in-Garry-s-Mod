...
if CLIENT then
	...
	killicons_new.Add("weapon_cs16_pb_nade", "cs/sprites/hegrenade_killicon", Color(255, 255, 255, 255))
...
SWEP.VModel				= Model("models/weapons/cs16/c_hegrenade.mdl")
--SWEP.VModel				= Model("models/cs/v_hegrenade.mdl")

SWEP.VModel 			= Model("models/weapons/cs16/paintball/v_pb_nade.mdl")
...
function SWEP:Throw()
	...
	if SERVER then
		local grenade = ents.Create("ent_cs16_hegrenade")
